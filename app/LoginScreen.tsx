...
const styles = StyleSheet.create({
  ...
  langButton: { position: "absolute", top: 70, right: 30 },
  langIcon: { width: 28, height: 28 },
  logoRow: {
    flexDirection: "row",
    alignItems: "center",
    marginTop: 250,
  ...
  logoTextTop: { fontSize: 28, fontWeight: "bold", color: "#fff" },
  logoTextBottom: { fontSize: 18, fontWeight: "bold", color: "#fff" },
  bottomSection: {
    flex: 1,
  ...
  signup: { marginTop: 20, marginBottom: 10, color: "#fff" },
});
